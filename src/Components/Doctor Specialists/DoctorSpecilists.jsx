...
const DoctorSpecilists = () => {
    let doctors_category = [
        { id: 1, imgUrl: 'blog_one.jpg', doctor_name: 'aliza', special: 'birds specialist', experience: '3 years of experience' },
        { id: 2, imgUrl: 'boyone.jpg', doctor_name: 'abdullah', special: 'dogs specialist', experience: '4 years of experience' },
        { id: 3, imgUrl: 'boytwo.jpg', doctor_name: 'muzamil', special: 'reptile specialist', experience: '3 years of experience' },
        { id: 4, imgUrl: 'boyfour.jpg', doctor_name: 'hannan', special: 'fishs specialist', experience: '3 years of experience' },
        { id: 5, imgUrl: 'femaletwo.jpg', doctor_name: 'tokyo', special: 'nuerology specialist', experience: '3 years of experience' },
        { id: 6, imgUrl: 'femalethree.jpg', doctor_name: 'carla', special: 'nutrition specialist', experience: '3 years of experience' },
    ]
    return (
        <>
            <Header />
